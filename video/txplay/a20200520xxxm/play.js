/*! Txplayer - v3.0.0 - 2020-07-01 10:49:21
 * Copyright (c) 2020
...
function(a, b, c) {
    function d(a) {
        ...
        this.userMsg = new i,
        this.userMsg.__name = "userMsg",
        this.userMsg.setMaxListeners(100);
        var g = f.filterXSS(e.extend({},
        j));
        ...
        } else g.browserDisableAutoPlay = !1,
        e.v4log("browserDisableAutoPlay", "autoplay is ok");
        var p = e.getData(d.dataset.localStorageKey.userSetting);
        if (p) {
            var r = /\"isSkipPrelude\"/.test(p),
            s = /\"isSkipPrelude\":1/.test(p);
            r && (g.skipPrelude = s)
        }
        ...
        try {
            ...
            g.settings || {},
            g.extendSettings || {}),
            g.extendPluginsMap[g.videoType] = a.extendPluginsMap ? e.extend({},
            j.extendPluginsMap[g.videoType] || {},
            g.extendPluginsMap[g.videoType] || {}) : g.extendPluginsMap[g.videoType]
        } catch(n) {}
        var z = {
            config: g,
            msg: c,
            ...
            dataset: {
                testVer: y,
                playerCreateStartTime: +new Date,
                disableShowHtml5Switch: !g.showHTML5Switch
            },
            userApi: this,
            privateApi: {}
        };
        ...
        m.exportsReportApi(z),
        g.vid && (m.reportTxplayer(z, {
            playType: g.playerType,
            videoType: g.videoType
        }), d.dataset._instance[g.playerId] = this),
        z.msg.on("reportPluginLoadError",
        function(a) {
        ...
        d.dataset.H5PlayerStyleUrl[g.playerType] && d.$ && d.$.Deferred && e.loadCss(d.dataset.H5PlayerStyleUrl[g.bannerNewsUI ? "news": g.playerType]),
        "flash" === g.playerType && (d.dataset.flashVersion = e.getFlashVersion()),
        g.autoplay && g.createOnClick && ["h5", "h5tiny"].indexOf(g.playerType) !== -1 && (z.dataset.emptyVideo = f.insertEmptyVideo(g));
        ...
        this.on = function(a, c) {
            return "string" != typeof a ? (e.error("player.on(evtName, fn), evtName must be a String"), this) : "function" != typeof c ? (e.error("player.on(evtName, fn), fn must be a Function"), this) : (b.userMsg.on(a,
            function() {
                c.apply(b, arguments)
            }), this)
        },
        ...
        this.once = function(a, c) {
            return "string" != typeof a ? (e.error("player.once(evtName, fn), evtName must be a String"), this) : "function" != typeof c ? (e.error("player.once(evtName, fn), fn must be a Function"), this) : (b.userMsg.once(a,
            function() {
                c.apply(b, arguments)
            }), this)
        },
        location.search && location.search.indexOf("testcase") > -1) {
            ...
            D.src = "//vm.gtimg.cn/tencentvideo/module/txp/tools/txplayerLogger.js",
    ...
    d.msg = new i,
    d.msg.setMaxListeners(500),
    d.dataset = g,
    d.dataset.debug = 1 == e.getUrlParam("debug"),
    d.defaultconfig = j,
    d.errcode = n,
    d.util = e,
    d.Events = i,
    ...
    d.appVersion = p,
    o && (d.$.tmpl = l),
    window.Txplayer || (window.Txplayer = d),
    d.dataset.ts = "1593571761179"
},
function(a, b) { !
    function(a) {
        "use strict";
        ...
        function l() {
            ...
            this._initBody = function(a) {
                if (this._bodyInit = a, a) if ("string" == typeof a) this._bodyText = a;
                ...
                else if (r.arrayBuffer && r.blob && t(a)) this._bodyArrayBuffer = k(a.buffer),
        ...
        if (!a.fetch) {
            var r = {
                ...
                blob: "FileReader" in a && "Blob" in a &&
                function() {
                    try {
                        return new Blob,
                        !0
...
function(a, b, c) {
    var d = {
        getHlsAdOffsetTime: function(a, b, c) {
            var d = b.dataset.hlsAdTimeRanges,
            e = b.dataset.useHls;
        ...
        fiddlerLog: function(a) {
            Txplayer && Txplayer.dataset && !Txplayer.dataset.debug || ("string" != typeof a && "number" != typeof a || (a = {
                a: a
            }), (new Image).src = "http://test.m.v.qq.com/txplayer?" + Txplayer.$.param(a))
        },
        cookie: {
        ...
        getRelativeUrl: function(a) {
            if ("string" == typeof a) {
                ...
                b.href = a;
                var c;
                return c = b.pathname && "string" == typeof b.pathname ? b.pathname: "",
                "//" + b.host + ("/" !== c[0] ? "/" + c: c)
            }
        },
        loadCss: function(a) {
            ...
            f = function(a) {
                ...
                e.onerror = function() {
                    ...
                    var g = {};
                    g["__t" + c] = +new Date,
                    f(d.appendParamsToUrl(a, g))
                },
                e.href = a,
                Txplayer.$("head")[0].appendChild(e)
            },
            g = d.getRelativeUrl(a);
            return Txplayer.$('link[rel="stylesheet"]').each(function(a, b) {
                var c = b.href;
                if (c && c.indexOf(g) > -1) return e = !0,
                !1
            }),
            e ? b.resolve() : (a = d.appendParamsToUrl(a, {
        ...
        getDefaultPosterByVid: function(a) {
            var b = ["496_280"],
            c = "//shp.qpic.cn/qqvideo_ori/0/{vid}_{index}/0";
        ...
        loadScript: function(a) {
            ...
            if (a.url) {
                var f = d.getOriginURL(a.url),
                g = function(a) {
                    var b;
                    if (Txplayer.dataset.loadScriptDefer && Txplayer.dataset.loadScriptDefer[f] && Txplayer.dataset.loadScriptDefer[f].constructor === Array) for (; Txplayer.dataset.loadScriptDefer[f].length > 0;) b = Txplayer.dataset.loadScriptDefer[f].shift(),
                ...
                Txplayer.dataset.loadScriptDefer[f] = [a.onsuccess],
                b.async = "async",
                b.src = a.url,
                b.charset = "utf-8",
                a.crossorigin && b.setAttribute("crossorigin", "anonymous"),
        ...
        getFlashVersion: function() {
            ...
            if (Txplayer.util.browser.ie) try {
                ...
                b && (c = b.GetVariable("$version"), c && (c = c.split(" ")[1].split(","), d = [parseInt(c[0], 10), parseInt(c[1], 10), parseInt(c[2], 10)]))
            } catch(h) {} else "undefined" != typeof f.plugins && "object" == typeof f.plugins[e] && (c = f.plugins[e].description, !c || "undefined" == typeof f.mimeTypes && f.mimeTypes[g] && !f.mimeTypes[g].enabledPlugin || (c = c.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), d[0] = parseInt(c.replace(/^(.*)\..*$/, "$1"), 10), d[1] = parseInt(c.replace(/^.*\.(.*)\s.*$/, "$1"), 10), d[2] = /[a-zA-Z]/.test(c) ? parseInt(c.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0));
            return a = d.join(".")
        },
        ...
        getStdfrom: function(a, b) {
            ...
            var c = "view.inews.qq.com" === location.hostname,
            d = location.hostname.indexOf("caixin.com") > -1;
        ...
        getPlatform: function() {
            var a = d.getBusinessId(),
            b = d.getDeviceId();
            return 1e4 * a + 100 * b + 1
        },
        getDeviceCode: function() {
            var a = 0;
            return d.os.iphone ? a = 2 : d.os.ipad ? a = 3 : d.os.android && d.phone && (a = 1),
            a
        },
        getPlatformCode: function() {
            var a = 0;
            return d.browser.wechat ? a = 1 : d.browser.mqq ? a = 2 : d.browser.mqqbrowser && (a = 3),
            a
        },
        ...
        getMobileVideoPosterByVid: function(a, b) {
            b = void 0 !== b ? b: 2;
            var c = ["496_280", "360_204", "228_128"],
            d = "//shp.qpic.cn/qqvideo_ori/0/{vid}_{index}/0";
            return b >= c.length && (b = c.length - 1),
            d.replace("{vid}", a).replace("{index}", c[b])
        },
        getPcVideoPosterByVid: function(a, b) {
            function c(a) {
                for (var b = 1e8,
                c = 0,
                d = 0; d < a.length; d++) c = (c << 5) + c + a.charCodeAt(d);
                return c % b
            }
            if (b = b || ".png", !a) return "";
        ...
        getQQFromCookie: function() {
            ...
            return a && (a = a.replace(/\D/g, "").replace(/^0+/, "")),
            a
        },
        ...
        isSupportM3u8: function() {
            ...
            c = !1;
            if ("function" == typeof a.canPlayType) for (var d = 0,
            e = b.length; d < e; d++) if (a.canPlayType(b[d])) {
                c = !0;
                break
            }
            return a = null,
        ...
        isSupportChromeHls: function(a) {
            ...
            var b = !1;
            a && (b = !!a.official);
            var c = ["10201", "70201", "3670201", "10901", "70901", "4100201"],
            d = a && this.inArray(c, "" + a) > -1;
        ...
        whenWechatIsReady: function(a) {
            var b = Txplayer.$.Deferred(),
            c = a.timeout || 5e3;
            return Txplayer.util.browser.wechat && ("undefined" != typeof WeixinJSBridge && WeixinJSBridge.on ? b.resolve() : (document.addEventListener("WeixinJSBridgeReady",
            function() {
                b.resolve()
            }), setTimeout(function() {
                b.reject()
        ...
        formatPlayTime: function(a) {
            if ("string" == typeof a && (a = parseInt(a)), "number" == typeof a) {
                ...
                return b = parseInt(a / 3600),
                c = parseInt((a - 3600 * b) / 60),
                d = parseInt(a - 3600 * b - 60 * c),
                0 === b ? [e(c), e(d)].join(":") : [b, e(c), e(d)].join(":")
            }
        },
        ...
        loadPlugins: function(a, b, c, e) {
            function f() {
                function a(c) {
                    var e = function() {
                        g(i),
                        "TxpCreativePlayer" === i && (Txplayer.dataset.isReadyPlugins.push(i), b.msg && b.msg.broadcast && b.msg.broadcast("pluginReady", {
                            name: i
                        }), b.userMsg && b.userMsg.broadcast && b.userMsg.broadcast("pluginReady", {
                            name: i
                        }))
                    },
                    j = function() {
                        if (b && b.msg && b.msg.broadcast) {
                            if (b.msg.broadcast("reportPluginLoadError", {
                                ...
                                var a = "62";
                                Txplayer.util.os.windows && (a = "61"),
                                "h5" !== b.config.playerType && "h5tiny" !== b.config.playerType || (a = "64"),
                                b.dataset.errorCodeOfStep5 = a + "200.10002",
                                b.msg.broadcast("reportPluginLoadError", {
                                    name: i,
                                    url: h,
                                    requestStartTime: n,
                                    step: 50,
                            ...
                            Txplayer.util.localLog("PLUGINS_LOAD_ERROR", {
                                name: i,
                                url: h
                            })
                        }
                    ...
                    h && h.indexOf("_ts=") === -1 && (h += h.indexOf("?") > -1 ? "&_ts=" + Txplayer.dataset.ts || +new Date: "?_ts=" + Txplayer.dataset.ts || +new Date),
                    d.loadScript({
                        url: h,
                        crossorigin: !!c,
                ...
                var h, i = j.shift(),
                k = 0,
                l = b.config && b.config.loadPluginCrossOrigin,
                m = i.toLowerCase() + ".js",
                n = +new Date;
                Txplayer && Txplayer.hashMaps && Txplayer.hashMaps[m] && (m = Txplayer.hashMaps[m]),
                c && c.hasOwnProperty(i) && c[i].url && (h = c[i].url, l = !1),
                h || (h = Txplayer.dataset.jsBasePath + "plugins/" + m),
                Txplayer.plugins.hasOwnProperty(i) ? g(i) : "TxpCreativePlayer" === i ? (h = "//vm.gtimg.cn/tencentvideo/txpv5/creative/plugins/txp-creative-player." + Txplayer.appVersion + ".js", "undefined" != typeof window.TxpCreativePlayer ? (g(i), Txplayer.dataset.isReadyPlugins.push(i), b.msg && b.msg.broadcast && b.msg.broadcast("pluginReady", {
                    name: i
                }), b.userMsg && b.userMsg.broadcast && b.userMsg.broadcast("pluginReady", {
                    name: i
                })) : a(l)) : a(l)
            ...
            function g(a) {
                Txplayer.dataset.pluginsLoadTime = Txplayer.dataset.pluginsLoadTime || [],
                Txplayer.dataset.pluginsLoadTime.push(a + ":" + Txplayer.util.dateFormat("yyyy-M-d h:m:s:S")),
                i = h(a),
                i && i.done && i.fail ? i.done(function() {
                    f()
                }) : f()
            }
            function h(a) {
                ...
                try {
                    k["_" + a] || (k["_" + a] = new Txplayer.plugins[a](b), Txplayer.dataset.isReadyPlugins.push(a), b.msg && b.msg.broadcast && b.msg.broadcast("pluginReady", {
                        name: a
                    }), b.userMsg && b.userMsg.broadcast && b.userMsg.broadcast("pluginReady", {
                        name: a
                    }))
                    ...
                    e = f.message,
                    d.showError("JS\u6709\u5f02\u5e38:" + a, e),
                    d.log(f.stack),
                    b.msg.broadcast && b.msg.broadcast("reportError", {
                        msg: e,
                        code: Txplayer.define.reportCode.JS_ERROR,
                        stack: f.stack
                    })
                }
                return a.indexOf("HtmlFrame") == -1 && !
                function(a, b, c) {
                    a && (a.addDestroyToPlugin = function() {
                        var d = this.context.superMsg || this.context.msg;
                        d.on("destroyPlugin",
                        function(e, f) {
                            e && e !== b || ("function" === Txplayer.$.type(a.remove) && a.remove(), a && a.dataset && (a.dataset.moduleApis || a.dataset.privateApis || a.dataset.eventsList) && (a.dataset.moduleApis && Txplayer.$.each(a.dataset.moduleApis,
                            function(a, b) {
                                d.off(a)
                            }), a.dataset.privateApis && Txplayer.$.each(a.dataset.privateApis,
                            function(a, b) {
                                d.off(a)
                            }), a.dataset.eventsList && Txplayer.$.each(a.dataset.eventsList,
                            function(a, b) {
                                d.off(a)
                            })), a && a.dataset && Txplayer.$.each(a.dataset,
                            function(a, b) { / _TIMER / .test(a) && b && (clearInterval(b), clearTimeout(b))
                            }), Txplayer.$.each(a,
                            function(a, b) {
                                b = null
        ...
        getTxVideoPageURLByVid: function(a, b, c) {
            ...
            return c && (e += "?start=" + parseInt(c)),
            e
        },
        getBrowserBrand: function() {
            var a = Txplayer.util.browser,
            b = "";
            return a.qqbrowser ? b = "qqbrowser": a.chrome ? b = "chrome": a.firefox ? b = "firefox": a.safari ? b = "safari": a.ie && (a.ie.version ? (a.ie.version += "", b = "ie" + a.ie.version.split(".").shift()) : b = "ie"),
            b
        },
        xss: function(a) {
        ...
        isInScreen: function(a) {
            ...
            var e, f, g = Txplayer.$(a),
            h = g.offset();
            return window.Zepto ? (e = g.width(), f = g.height()) : (e = g.outerWidth(), f = g.outerHeight()),
            h.right = h.left + e,
            h.bottom = h.top + f,
            !(c.right < h.left || c.left > h.right || c.bottom < h.top || c.top > h.bottom)
        },
        ...
        addPageVisibilityChangeEvent: function(a) {
            ...
            Txplayer.$(document).on(b.visibilityChange,
            function() {
        ...
        getPTAG: function() {
            for (var a = this.getUrlParam,
            b = this.getDomainOfURL,
            c = Txplayer.$,
            d = this.cookie,
            e = document.location.toString().toLowerCase(), f = "", g = ["ptag", "adtag", "pgv_ref"], h = 0, i = g.length; h < i && !(f = a(g[h], e)); h++);
            if (!f) try {
        ...
        extend: function() {
            ...
            if (! (a.length <= 1)) {
                ...
                d = c,
                e = a.callee; d > 0; d--) a[d - 1] = e(a[d - 1], a[d]);
                return a[0]
            }
        },
        inArray: function(a, b) {
            var c = -1;
            if ("object" == typeof a && a.constructor === Array && a.length) for (var d = 0,
            e = a.length; d < e; d++) if (a[d] === b) {
                c = d;
                break
            }
            return c
        ...
        getUin: function(a) {
            var b = this.cookie.get("skey"),
            c = (this.cookie.get("lskey"), ""),
            d = 0,
            e = !1;
        ...
        removeArrayItem: function(a, b, c) {
            ...
            "object" != typeof a || a.constructor !== Array ? a: b < 0 ? a: (a.splice(b, c), a)
        },
        ...
        getFormatUA: function() {
            var a = "other";
            return d.browser.qqlive && (d.os.iphone ? a = "iphone_qqlive": d.os.android && (a = "aphone_qqlive")),
            a
        },
        ...
        getP2pConfig: function(a) {
            var b = [];
            return Txplayer.$.each(a.dataset.filmVideoData[0].urlArray,
            function(a, c) {
                b.push(c.url || "")
            }),
            {
        ...
        pluginNameToV4: function(a, b) {
            if (a = a || [], b = b || [], 0 != a.length && 0 != b.length) for (var c = 0,
            d = b.length; c < d; c++) {
        ...
        inWhichDomain: function(a) {
            if (!a) return ! 1;
            var b = {
                kuaibao: ["kuaibao.qq.com", "m.gamefeeds.qq.com", "kandian.qq.com", "mcdn.kandian.qq.com"],
        ...
        safariDisableAutoPlay: function() {
            ...
            b = ["v.qq.com", "ke.qq.com", "y.qq.com", "fudao.qq.com"];
            if (this.isInIframe()) try {
        ...
        getVideoType: function() {
            var a = "";
            return "v.qq.com" === location.hostname && (window.COVER_INFO && window.COVER_INFO.typeid ? a = +window.COVER_INFO.typeid: window.VIDEO_INFO && window.VIDEO_INFO.type && (a = +window.VIDEO_INFO.type)),
            a
        },
        validVid: function(a) {
        ...
        preGetMacClientInfo: function(a) {
            function b(a) {
                try {
                    window.TenvideoJSBridge.callHandler("getSystemInfo", {},
                    function(b) {
            ...
            if (Txplayer.util.os.mac && Txplayer.util.browser.macqqlive) try {
                window.TenvideoJSBridge && window.TenvideoJSBridge.callHandler ? b(a) : document.addEventListener("onTenvideoJSBridgeReady",
                function() {
        ...
        getQQLiveDeviceInfo: function(a) {
            function b(a) {
                window.TenvideoJSBridge.invoke("getDeviceInfo", null,
                function(b) {
            ...
            Txplayer.util.mobile && Txplayer.util.browser.qqlive ? window.TenvideoJSBridge && TenvideoJSBridge.invoke ? b(a) : document.addEventListener("onTenvideoJSBridgeReady",
            function() {
        ...
        xhrReport: function(a) {
            var b = a.url || "";
            /^http(s)?:/.test(b) || (b = location.protocol + b),
            b.indexOf("_dc") === -1 && (b += "&_dc=" + Math.random());
            var c = new XMLHttpRequest;
            c.open(a.method || "POST", b),
            c.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"),
            a.withCredentials && (c.withCredentials = !0),
            c.send(Txplayer.$.param(a.data))
        },
        ...
        supportHDCP: function() {
            ...
            a.v4log("Requesting Widevine system access..."),
            navigator.requestMediaKeySystemAccess("com.widevine.alpha", c).then(function(a) {
                return a.createMediaKeys()
            }).then(function(c) {
                return a.v4log("Getting HDCP status..."),
                "getStatusForPolicy" in c ? c.getStatusForPolicy({
                    minHdcpVersion: b
                }) : window.Promise.reject("HDCP Policy Check API is not available.")
            }).then(function(c) {
        ...
        fetch: function(a) {
            ...
            return a.credentials && (c.credentials = a.credentials),
            window.fetch(a.url, c).then(function() {},
            function() {
...
function(a, b) {
    function c(a) {
        ...
        this.phone = {},
        this.mobile = !1,
        a.indexOf("mobile") > -1 && (this.mobile = !0);
        var b, c, d = {
        ...
        for (var e in d) if (b = d[e].exec(a)) {
            ...
            this.os[c] = !0,
            this.os.name = c,
            b[1] && (this.os.version = b[1].replace(/_/g, "."));
            break
        ...
        if (/windows/i.test(a) && /qqlive/i.test(a) && window.external && window.external.GetProtocalVersion && "function" == typeof window.external.GetProtocalVersion) {
            ...
            this.browser.pcqqlive = {
                version: j
            }
        }
        /mac\sos/i.test(a) && /qqlive_mac/i.test(a) && (this.browser.macqqlive = {}),
        this.os.android && this.browser.safari && delete this.browser.safari,
        this.browser.chrome && this.browser.safari && delete this.browser.safari,
        this.browser.ie && this.browser.ie.version && this.browser.ie.version.indexOf("trident") > -1 && (this.browser.ie.version.indexOf("6.0") > -1 ? this.browser.ie.version = "10": this.browser.ie.version.indexOf("5.0") > -1 ? this.browser.ie.version = "9": this.browser.ie.version.indexOf("4.0") > -1 ? this.browser.ie.version = "8": this.browser.ie.version = "11");
        var k, l = {
            ipod: /iPod/i,
            ipad: /iPad/i,
            iphone: /iPhone/i,
        ...
        for (var m in l) if (k = l[m].exec(a)) {
            this.phone.name = m.replace(/_\d+/, ""),
            k[1] && (this.phone.version = k[1].replace(/^[_-]/gi, ""));
            break
        }
...
function(a, b) {
    function c(a) {
        ...
        1e3), Txplayer.util.mobile || Txplayer.imgRpt ? Txplayer.util.requestViaImage(a) : Txplayer.util.fetch({
            ...
            d()
        }), void e(a)) : (i || (i = !0, Txplayer.msg && Txplayer.msg.on("ready",
        function() {
            f()
        })), void h.push(a))
    }
    ...
    function e(a) {
        if (a && Txplayer.util && Txplayer.util.getParams && Txplayer.dataset.showreport && window.console && "function" == typeof window.console.table) {
            var b = [],
            c = Txplayer.util.getParams(a);
            for (var d in c) b.push({
                key: d,
                value: decodeURIComponent(c[d])
            });
            c && c.BossId ? window.console.log("%c" + [c.BossId, c.step].join(" -- "), "color: green;") : window.console.log(a),
...
function(a, b, c) {
    ...
    function g(a) {
        var b = t.getData(u.localStorageKey.userSetting),
        c = {};
        if (b) {
            try {
    ...
    function i(a, b, c) {
        ...
        if (/_fp=f/.test(location.href)) try {
            ...
            "", location.href.replace(/\??&?_fp=f/, ""))
        } catch(k) {}
        t.browser.ie && "edge" !== t.browser.ie.version && (d = "flash", c.dataset.disableShowHtml5Switch = 1),
        d ? a.playerType = d: a.playerType || (a.playerType = f(a)),
        "html5hd" === a.playerType && (t.isSupportChromeHls(c.dataset.platform) ? a.playerType = "chromehls": t.isSupportSafariHls(c.dataset.platform) ? a.playerType = "safarihls": t.isSupportMP4() || (a.playerType = "flash", c.dataset.disableShowHtml5Switch = 1));
        var l = t.getUrlParam("forcestream");
        "0" !== l || "chromehls" !== a.playerType && "safarihls" !== a.playerType || (a.playerType = "html5hd"),
        !i && !d && "html5hd" == a.playerType && t.os.mac && t.browser.qqbrowser && (a.playerType = "flash"),
        ("h5" == a.playerType && t.os.android || ("h5tiny" == a.playerType || "h5" == a.playerType) && t.os.ios && t.os.version && t.compareVersion(t.os.version, "7") > 0) && t.browser.mqqbrowser && t.browser.mqqbrowser.version && t.compareVersion(t.browser.mqqbrowser.version, "7.3") >= 0 && location.host.indexOf("m.v.qq.com") !== -1 && !a.enableHevc && t.browser.chrome && (a.playerType = "h5qq"),
        !t.mobile || "flash" !== a.playerType && "html5hd" !== a.playerType && "chromehls" !== a.playerType && "safarihls" !== a.playerType || (a.playerType = "h5"),
        "chromehls" !== a.playerType && "safarihls" !== a.playType || (c.dataset.useHls = !0);
        var m = b[a.playerType];
        return a.extendPluginsMap && a.extendPluginsMap[a.videoType] && a.extendPluginsMap[a.videoType][a.playerType] && (m = m.concat(a.extendPluginsMap[a.videoType][a.playerType])),
        a.official || a.removePluginsList.push("UiFavorite", "UiOmSubscribe", "UiLanguage", "UiSettings", "UiBrowserFullScreen", "UiOnlyWatch", "EndRecommend", "UiNormalPoint", "UiBuyPlayPoint"),
        "nintendo" === a.playerType && a.removePluginsList.push("UiPlayNext", "UiBrowserFullScreen", "UiWindowFullScreen", "UiSpeed"),
        m = t.filterByArray(m, a.removePluginsList),
        "mp4link" !== a.playerType && "flash" !== a.playerType && "v4" != a.version && Array.prototype.indexOf && m.indexOf("H5PlayerAd") === -1 && m.push("H5PlayerAd"),
        "3.5.57" === c.dataset.testVer ? m.forEach(function(a, b) {
            if (/hlshelper/i.test(a)) return m[b] = "HlsHelperP2PEncrypt",
            c.dataset.useP2P = !0,
            !1
        }) : c.dataset.testVer === t.getUrlParam("debugusep2p") ? m.forEach(function(a, b) {
            if (/hlshelper/i.test(a)) return m[b] = "HlsHelperP2PDebug",
            c.dataset.useP2P = !0,
            !1
        }) : "3.6.3" === c.dataset.testVer && m.forEach(function(a, b) {
            if (/hlshelper/i.test(a)) return m[b] = "HlsHelperP2PAdaptive",
            c.dataset.useP2P = !0,
            !1
        }),
        m
    ...
    function l(a) {
        ...
        return a.guid || !t.browser.pcqqlive && !t.browser.macqqlive || (b = t.getPcClientGuid(), b || (b = t.getData(u.localStorageKey.userId))),
        b || (b = t.createGUID(), t.setData(u.localStorageKey.userId, b)),
        b
    }
    function m() {
    ...
    function n() {
        var a = "",
        b = location.host;
        return "v.qq.com" == b && (window.COVER_INFO && window.COVER_INFO.typeid ? a = +window.COVER_INFO.typeid: window.VIDEO_INFO && window.VIDEO_INFO.type && (a = +window.VIDEO_INFO.type)),
        a
    }
    function o(a) {
        if ("0" === t.getUrlParam("debugp2p")) return ! 1;
        if ("1" === t.getUrlParam("debugp2p")) return t.isSupportChromeHls({
            official: !0
        });
        var b = !t.inNewIframe() && ("v.qq.com" === location.hostname || "film.qq.com" === location.hostname);
        return b && t.isSupportChromeHls({
            official: !0
        })
    }
    function p(a) {
...
function(a, b, c) {
    ...
    e = {
        ...
        settings: {
            ...
            H5UiControl: {
                subPlugins: function() {
                    ...
                    return d.os.ios && a.unshift("H5PlaybackRate"),
                    a
                } ()
            },
            UiSettings: {},
        ...
        showHTML5Switch: function() {
            var a = 1,
            b = d.getUrlParam("debug");
            return "1" != b && "true" != b || (a = 1),
            a = "v.qq.com" == location.hostname ? a: 0,
            d.os.mac && (a = 1),
            a
        } (),
        businessId: 0,
        ...
        official: function() {
            var a = !1,
            b = d.getUrlParam("official");
            return /^http(s?):\/\/v.qq.com\/x\/(cover|page)\//.test(location.href) && (a = !0),
            b && (a = !1, "1" != b && "true" != b || (a = !0)),
            a
        } (),
        useMiniSkin: !1,
        miniSkinAdaptive: !0
...
function(a, b, c) {
    var d = c(3),
    e = "//vm.gtimg.cn/tencentvideo/txp/style/txp_desktop.css",
    f = {
        maxId: 0,
    ...
    f.sessionStorageKey = {
        languageSwitch: "txp-language-switch"
    },
    a.exports = f
},
function(a, b, c) {
    function d(a, b, c, d, e, g) {
        f.loadPlugins.call(a, b, c, d.settings,
        function() {
            c.dataset.isReady = !0,
            c.dataset.playerCreateEndTime = +new Date,
            "flash" !== d.playerType && (a.userMsg.broadcast("ready"), e.broadcast("ready"), Txplayer.dataset.ready ? setTimeout(function() {
    ...
    function e(a, b, c, e, h, i) {
        ...
        v = f.isArray(e.removePluginsList),
        w = function(a) {
            v && f.inArray(e.removePluginsList, a) > -1 || f.inArray(e.removePluginsList, a.substr(2)) > -1 || l.push(a)
        },
        x = function(a) {
            if ("string" == typeof a && (e.settings[a] ? e.settings.hasOwnProperty(a) && !e.settings[a].url && w(a) : w(a), e.settings[a] && f.isArray(e.settings[a].subPlugins))) for (var b = 0,
            c = e.settings[a].subPlugins.length; b < c; b++) x(e.settings[a].subPlugins[b])
        };
        ...
        var y = function() {
            ...
            var j = n.shift();
            j += "?max_age=604800&_ts=" + Txplayer.dataset.ts,
            f.loadScript({
                url: j,
                crossorigin: !!e.loadPluginCrossOrigin,
                onsuccess: function(a) {
                    i || (i = "function" == typeof window.Zepto ? window.Zepto: "function" == typeof window.jQuery ? window.jQuery: "function" == typeof window.jq ? window.jq: null, i && (Txplayer.$ = i, Txplayer.$.tmpl = g)),
                    y()
                }
            })
        };
...
function(a, b) {
    var c = function(a, b) {
        return function(d, e) {
            ...
            return f.$ = f.$ || b + ".push('" + d.replace(/\\/g, "\\\\").replace(/[\r\t\n]/g, " ").split("<%").join("\t").replace(/((^|%>)[^\t]*)'/g, "$1\r").replace(/\t=(.*?)%>/g, "',$1,'").split("\t").join("');").split("%>").join(b + ".push('").split("\r").join("\\'") + "');return " + b,
            e ? f(e) : f
        }
    } ({},
    "$" + +new Date);
    a.exports = function(a, b) {
        return b && !b.svgPrefix && (b.svgPrefix = window.Txplayer && window.Txplayer.dataset && window.Txplayer.dataset.svgPrefix || ""),
        c(a, b)
    }
},
function(a, b) {
...
function(a, b, c) {
    var d = c(14),
    e = /debugevent=1/.test(location.href),
    f = {};
    ...
    d.prototype.off = function(a) {
        if (!a) return this;
        if (a.indexOf(".") > -1) return this.removeAllListeners.call(this, a),
        this;
    ...
    d.prototype.getData = function(a, b) {
        ...
        return this.emit.apply(this, d),
        c.async ? c.async: c.data
    },
    a.exports = d
},
function(a, b) {
    ...
    c.prototype.addListener = function(a, b) {
        ...
        this._events.newListener && this.emit("newListener", a, d(b.listener) ? b.listener: b),
        this._events[a] ? f(this._events[a]) ? this._events[a].push(b) : this._events[a] = [this._events[a], b] : this._events[a] = b,
        f(this._events[a]) && !this._events[a].warned && (e = g(this._maxListeners) ? c.defaultMaxListeners: this._maxListeners, e && e > 0 && this._events[a].length > e && (this._events[a].warned = !0, "function" == typeof console.trace)),
        this
    },
    ...
    c.prototype.removeListener = function(a, b) {
        ...
        this._events.removeListener && this.emit("removeListener", a, b);
            ...
            if (e < 0) return this;
            1 === c.length ? (c.length = 0, delete this._events[a]) : c.splice(e, 1),
            this._events.removeListener && this.emit("removeListener", a, b)
        }
        return this
    },
    c.prototype.removeAllListeners = function(a) {
        ...
        else if (c) for (; c.length;) this.removeListener(a, c[c.length - 1]);
...
function(a, b) {
    function c(a, b) {
        ...
        "flash" !== h.player_type && (h.sub_version = g(h.browser)),
        h.error_msg += "",
        h.error_stack += "",
        h.error_msg = h.error_msg.replace(/\$/g, ""),
        h.error_stack = h.error_stack.replace(/\$/g, ""),
        Txplayer.util.showInfo("\u9519\u8bef\u4e0a\u62a5", h);
        var i = "//btrace.video.qq.com/kvcollect?BossId=3720&Pwd=1814753491&";
        i += Txplayer.util.param(h),
        Txplayer.util.report(i)
    }
    function d(a) {
        function b() {
            var a;
        ...
        if (a && a.filename && a.message && a.filename.indexOf("//vm.gtimg.cn/tencentvideo/txp/js/") !== -1) {
            ...
            n += Txplayer.util.param(m),
            Txplayer.util.report(n)
        }
    }
    function e() {
    ...
    function h(a, b) {
        ...
        d += Txplayer.util.param(c),
        !Txplayer.util.isNewsPlugin && Txplayer.util.report(d)
    }
    function i(a, b) {
        var c = b.config.playerType,
        d = b.config.videoType,
        ...
        f += Txplayer.util.param(e),
        Txplayer.util.report(f)
    }
    function j(a, b) {
        var c = {
            gid: b.dataset.guid,
    ...
    function k(a, b) {
        ...
        c.vid = a.vid,
        c.int6 = a.promotionId,
        c.str4 = a.appCase,
        c.int5 = a.reportStep,
        c.str5 = a.str5 || "",
        c.str6 = Txplayer.util.getUrlParam("openid", Txplayer.util.getTopFrameUrl()),
        c.str6 = c.str6 || "",
        c.str3 = a.reportFrom || "",
        c.str7 = a.guid || "",
        Txplayer.util.showInfo("AppBanner\u4e0a\u62a5", c);
        var d = "//btrace.video.qq.com/kvcollect?BossId=4046&Pwd=176231195&_dc=" + Math.random();
        d += "&" + Txplayer.util.param(c),
        Txplayer.util.isNewsPlugin() && location.href.indexOf("newsdebug=1") == -1 ? Txplayer.util.getChance(10) && Txplayer.util.report(d) : Txplayer.util.report(d)
    }
    function l(a, b) {
        a = a || {};
        var c = b.dataset.txplayerAuth.raw(),
        d = {
            version: Txplayer.dataset.ver,
            pid: b.dataset.guid,
            vid: b.dataset.vid,
        ...
        e += Txplayer.util.param(d),
        Txplayer.util.showInfo("\u6210\u957f\u4f53\u7cfb\u65f6\u957f\u4e0a\u62a5", d),
        Txplayer.util.report(e)
    }
    function m(a, b) {
        a = a || {};
        ...
        e = "4564";
        a.hasOwnProperty("bossid") && (e = a.bossid),
        "4501" == e && "50" == a.step && (d = {
            reason: "",
            code: a.code || "",
            etime: +new Date
        ...
        c.step = a.step,
        a.hasOwnProperty("step") || (c.step = 61);
    ...
    function p(a, b) {
        if ("LD" === a.adtype) {
            ...
            if (! (a.step_duration < 0)) {
                ...
                k += Txplayer.$.param(j),
                1 == Txplayer.util.getUrlParam("debugadreport") ? window.console && window.console.log && window.console.log(j) : Txplayer.imgRpt ? Txplayer.util.requestViaImage(k) : Txplayer.util.fetch({
                    url: k,
                    credentials: "include"
                })
            }
    ...
    function q(a) {
        a.msg.on("reportError",
        function(b) {
            c(b, a)
        }),
        a.msg.on("reportUsrAction",
        function(b) {
            i(b, a)
        }),
        a.msg.on("reportGetinfo",
        function(b) {
            j(b, a)
        }),
        a.msg.on("reportAppBanner",
        function(b) {
            k(b, a)
        }),
        a.msg.on("reportLoginUserPlayTime",
        function(b) {
            l(b, a)
        }),
        a.msg.on("reportPluginLoadError",
        function(b) {
            m(b, a)
        }),
        a.msg.on("reportAdInfo",
        function(b) {
            p(b, a)
        })
    }
    window.addEventListener ? window.addEventListener("error", d) : window.attachEvent && window.attachEvent("onerror", d),
    a.exports = {
        reportTxplayer: h,
        reportError: c,
        reportAppBanner: k,
...
function(a, b) {
    var c = {};
    c.defaultMsg = c[10001] = c[50] = c[68] = c[71] = c[73] = c[74] = c[76] = c[77] = c[445] = c[444] = "\u554a\u54e6\uff0c\u6ca1\u80fd\u627e\u5230\u4f60\u8981\u7684\u8282\u76ee\u4fe1\u606f~",
    c[51] = c[52] = c[64] = c[61] = c[62] = c[63] = c[65] = c[66] = c[69] = c[81] = c[82] = c[84] = c[86] = c["80.10"] = c[94] = "\u554a\u54e6\uff0c\u672c\u6765\u5728\u8fd9\u513f\u7684\u89c6\u9891\u4e0d\u89c1\u4e86~",
    c[80] = c[83] = "\u554a\u54e6\uff0c\u7248\u6743\u539f\u56e0\uff0c\u8be5\u89c6\u9891\u6682\u65f6\u65e0\u6cd5\u64ad\u653e~",
    c[97] = "\u8bf7\u4f7f\u7528\u817e\u8baf\u89c6\u9891\u624b\u673a\u7aef\u6700\u65b0\u7248\u672c\u89e3\u9501\u89c2\u770b\u672c\u5185\u5bb9",
    c.getPlatformErrorCode = function(a, b, c) {
        var d = "-",
        e = "-",
        f = "-";
        return c = c || "00",
        d = Txplayer.util.os.mac ? "62": Txplayer.util.os.windows ? "61": "64",
        "getinfo" === a ? e = "101": "getkey" === a ? e = "102": "ad" === a ? e = "215": "player" === a && (e = "200"),
        "neterror" === b ? f = "140": "cgiInnerError" === b ? (f = "13", c && (c = "" + c), 2 === c.length && (c = "0" + c)) : "h5video" === b ? f = "111": "aderror" === b && (f = "150"),
        "aderror" !== b || Txplayer.util.os.windows || Txplayer.util.os.mac || (f = "151"),
        d + e + "." + f + c
    },
    a.exports = c
},
...
function(a, b, c) {
    ...
    d.prototype.ad = function() {
        for (var a = [["opid", "openid"], ["appid", "appid"], ["atkn", "access_token"], ["uid", "vuserid"], ["tkn", "vusession"]], b = this.raw(), c = {
            lt: b.main_login || ""
        },
...
function(a, b) {
    Txplayer.hashMaps = {
        "barrage.js": "barrage.988c06.js",
        "barragefloat.js": "barragefloat.d4b190.js",
        "downloadmonitor.js": "downloadmonitor.058ac5.js",
        "endrecommend.js": "endrecommend.aed342.js",
        "flashplayer.js": "flashplayer.ff1646.js",
        "h5defn.js": "h5defn.3e60c2.js",
        "h5downloadbanner.js": "h5downloadbanner.c348e5.js",
        "h5downloader.js": "h5downloader.2e9289.js",
        "h5followbanner.js": "h5followbanner.bd09ce.js",
        "h5fullbanner.js": "h5fullbanner.107f83.js",
        "h5hdbanner.js": "h5hdbanner.c9e696.js",
        "h5htmlframe.js": "h5htmlframe.e0f70c.js",
        "h5interactbanner.js": "h5interactbanner.c09fdf.js",
        "h5limitbanner.js": "h5limitbanner.204d2e.js",
        "h5login.js": "h5login.982055.js",
        "h5mreport.js": "h5mreport.4ce17b.js",
        "h5pagebanner.js": "h5pagebanner.553d75.js",
        "h5pausebanner.js": "h5pausebanner.e263c4.js",
        "h5playbackrate.js": "h5playbackrate.970808.js",
        "h5player.js": "h5player.84bce3.js",
        "h5playerad.js": "h5playerad.17c6ba.js",
        "h5playercontrol.js": "h5playercontrol.ccaf02.js",
        "h5qqplayer.js": "h5qqplayer.2d2ca6.js",
        "h5rcdbanner.js": "h5rcdbanner.eba639.js",
        "h5report.js": "h5report.f2368f.js",
        "h5topbanner.js": "h5topbanner.efbab8.js",
        "h5uicontrol.js": "h5uicontrol.59d1e2.js",
        "h5uidefnloading.js": "h5uidefnloading.f4a20b.js",
        "h5uierrorshow.js": "h5uierrorshow.00dd3c.js",
        "h5uifullscreen.js": "h5uifullscreen.39613f.js",
        "h5uilimit.js": "h5uilimit.5a822a.js",
        "h5uiloading.js": "h5uiloading.6a878d.js",
        "h5uilogo.js": "h5uilogo.e09a29.js",
        "h5uimp4link.js": "h5uimp4link.a4c7c2.js",
        "h5uiplay.js": "h5uiplay.366190.js",
        "h5uiposter.js": "h5uiposter.e31a39.js",
        "h5uiprogress.js": "h5uiprogress.934b54.js",
        "h5uispeedy.js": "h5uispeedy.72f0ee.js",
        "hdadadapter.js": "hdadadapter.fb90a4.js",
        "hdhotkey.js": "hdhotkey.644a1f.js",
        "hdplayer.js": "hdplayer.0a5619.js",
        "hdplayercontrol.js": "hdplayercontrol.0d738e.js",
        "hdplayerhistory.js": "hdplayerhistory.509f4a.js",
        "hdplayerreport.js": "hdplayerreport.7b1993.js",
        "hdsupport.js": "hdsupport.02f3f2.js",
        "hlshelper.js": "hlshelper.01ee7d.js",
        "hlshelperp2p.js": "hlshelperp2p.8ea1f6.js",
        "hlshelperp2padaptive.js": "hlshelperp2padaptive.ffe04c.js",
        "hlshelperp2pdebug.js": "hlshelperp2pdebug.c138f6.js",
        "hlshelperp2pencrypt.js": "hlshelperp2pencrypt.20bd4d.js",
        "htmlframe.js": "htmlframe.0302dc.js",
        "playerhistoryreport.js": "playerhistoryreport.0437af.js",
        "tinyrcdbanner.js": "tinyrcdbanner.1e8f56.js",
        "tinyuiplay.js": "tinyuiplay.71d83e.js",
        "uibarragebtn.js": "uibarragebtn.66d73d.js",
        "uibrowserfullscreen.js": "uibrowserfullscreen.193efd.js",
        "uibuyplaypoint.js": "uibuyplaypoint.78d910.js",
        "uiclock.js": "uiclock.32d89b.js",
        "uiconsole.js": "uiconsole.c07af4.js",
        "uicontinueplay.js": "uicontinueplay.4ecabc.js",
        "uicontrol.js": "uicontrol.e391cf.js",
        "uicontrolplay.js": "uicontrolplay.09c835.js",
        "uidefinition.js": "uidefinition.8950ad.js",
        "uidialog.js": "uidialog.7f6279.js",
        "uiduration.js": "uiduration.5fa6fb.js",
        "uierror.js": "uierror.e94902.js",
        "uiipadlimit.js": "uiipadlimit.ac85d4.js",
        "uilanguage.js": "uilanguage.c4d5b8.js",
        "uiloading.js": "uiloading.728204.js",
        "uiloadingwithad.js": "uiloadingwithad.4c7c82.js",
        "uilogo.js": "uilogo.b4f7d3.js",
        "uiloopplay.js": "uiloopplay.fa70a0.js",
        "uinormalpoint.js": "uinormalpoint.620037.js",
        "uiomsubscribe.js": "uiomsubscribe.94aa36.js",
        "uionlywatch.js": "uionlywatch.0fec4c.js",
        "uiopenclientbubble.js": "uiopenclientbubble.36d2eb.js",
        "uioverlayplay.js": "uioverlayplay.5b055f.js",
        "uipip.js": "uipip.970653.js",
        "uiplay.js": "uiplay.28357a.js",
        "uiplaynext.js": "uiplaynext.9d601d.js",
        "uiposter.js": "uiposter.3158c3.js",
        "uipreview.js": "uipreview.1958cb.js",
        "uipreviewad.js": "uipreviewad.1ecb47.js",
        "uipreviewlist.js": "uipreviewlist.aeff48.js",
        "uiprogress.js": "uiprogress.f05efc.js",
        "uirightclickmenu.js": "uirightclickmenu.ab7ce0.js",
        "uiscreenpercent.js": "uiscreenpercent.8a24e7.js",
        "uisettings.js": "uisettings.b1376e.js",
        "uisettingsII.js": "uisettingsII.ec7620.js",
        "uishadow.js": "uishadow.04f083.js",
        "uishowtime.js": "uishowtime.0d513e.js",
        "uispeed.js": "uispeed.58b248.js",
        "uitips.js": "uitips.0fb7c5.js",
        "uititle.js": "uititle.9b74ef.js",
        "uitogglesidebar.js": "uitogglesidebar.7b5269.js",
        "uitrbtngroup.js": "uitrbtngroup.4a12f2.js",
        "uiunofficialendtip.js": "uiunofficialendtip.77810e.js",
        "uivolume.js": "uivolume.f0a07f.js",
        "uiwatermark.js": "uiwatermark.c976e7.js",
        "uiwatermarkaction.js": "uiwatermarkaction.1f0136.js",
        "uiwindowfullscreen.js": "uiwindowfullscreen.a308ba.js",
        "v4h5report.js": "v4h5report.c6870b.js",
        "v4hdplayer.js": "v4hdplayer.b48ba5.js",
        "v4hdplayercontrol.js": "v4hdplayercontrol.6572a1.js",
        "v4hdplayerreport.js": "v4hdplayerreport.10e9b4.js",
        "v4uicontrolplay.js": "v4uicontrolplay.29f8b5.js",
        "v4uidefinition.js": "v4uidefinition.913da0.js",
        "v4uierror.js": "v4uierror.be8d37.js",
        "v4uivolume.js": "v4uivolume.a42bae.js",
        "videointeractive.js": "videointeractive.63ed60.js"
    }
}]),
function() {
    if (window.Txplayer && Txplayer.dataset) {
        var a = {
            ...
            lastModify: "2020-7-1 10:49:21 \u251cF10: AM\u2524",
            ts: "1593571761183",
            ver: "3.3.762"
        };
